...
class DoneFragment: DataBindingFragment<FragmentTaskChildBinding>(R.layout.fragment_task_child) {
    ...
    private fun observeData() {
        viewModel.doneGoalLiveData.observe(viewLifecycleOwner, Observer(::setGoalData))
    }
