...
import com.indaco.samples.BuildConfig
...
interface BartService {
    ...
    @GET(BASE_URL + "stn.aspx?cmd=stns&key=${com.indaco.samples.BuildConfig.BART_KEY}&json=y")
    ...
    fun getStationSchedule(
        ...
        @Query("key") key: String = com.indaco.samples.BuildConfig.BART_KEY,
