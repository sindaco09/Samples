        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            with(holder.binding) {
                ...
                if (selectedItem != null && selectedItem!!.second == station) {
                    item.setBackgroundColor(context!!.getColor(appR.color.design_default_color_primary))
                    text.setTextColor(context!!.getColor(appR.color.white))
                } else {
                    item.setBackgroundColor(context!!.getColor(appR.color.white))
                    text.setTextColor(context!!.getColor(appR.color.black))
                }
            }
        }
