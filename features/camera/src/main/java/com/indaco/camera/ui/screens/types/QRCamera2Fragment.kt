...
import com.indaco.camera.databinding.FragmentQrCameraLegacyBinding
import com.indaco.camera.util.barcode.legacy.QRCodeImageReader
...
class QRCamera2Fragment: Fragment(R.layout.fragment_qr_camera_legacy) {

    companion object {
        private const val TAG = "QRCameraLegacyFragment"
    }

    private val binding by viewBinding(FragmentQrCameraLegacyBinding::bind)
